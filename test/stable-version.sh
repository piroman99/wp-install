...
DNSMGRURL=https://${domain1_dnsmgr}/manager/dnsmgr?out=text&authinfo=${user_dnsmgr}:${pass_dnsmgr}
DNSMGRURL=https://${domain2_dnsmgr}/manager/dnsmgr?out=text&authinfo=${user_dnsmgr}:${pass_dnsmgr}
CHANGESONLY=yes
